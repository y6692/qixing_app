 ...
 * @author vondear
 */
public class ActivityScanerCode2 extends SwipeBackActivity implements View.OnClickListener, OnConnectionListener
...
//            mCamera.setPreviewCallback(null);
    ...
    private void resetCamera(SurfaceHolder surfaceHolder){
        ...
        if (handler == null) {
            handler = new CaptureActivityHandler2(ActivityScanerCode2.this);
        }
...
//                                "<p style=\"color: #666666; font-size: 16px;\">1\u5c0f\u65f6\u5185\u514d\u8d39\uff0c\u8d85\u8fc71\u5c0f\u65f6<span style=\"color: #FF0000;\">\uffe5<span style=\"font-size: 24px;\">1.00<\/span><\/span>\/30\u5206\u949f<\/p>"
                                ...
                                ActivityScanerCodePermissionsDispatcher2.connectDeviceWithPermissionCheck(ActivityScanerCode2.this, deviceuuid);
...
//                                    }
                                    ...
                                    CustomDialog.Builder customBuilder = new CustomDialog.Builder(ActivityScanerCode2.this);
                                    customBuilder.setMessage("电单车必须在校内停车线还车");
        ...
        BaseApplication.getInstance().getIBLE().startScan(new OnDeviceSearchListener() {
            ...
            public void onScanDevice(BluetoothDevice device, int rssi, byte[] scanRecord) {
                ...
                if (m_nowMac.equalsIgnoreCase(device.getAddress())){
                    ...
                    BaseApplication.getInstance().getIBLE().stopScan();
                    BaseApplication.getInstance().getIBLE().connect(m_nowMac, ActivityScanerCode2.this);
                }
            }
        });
