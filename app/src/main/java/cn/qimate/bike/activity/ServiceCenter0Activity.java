...
public class ServiceCenter0Activity extends SwipeBackActivity implements View.OnClickListener,SwipeRefreshLayout.OnRefreshListener,AdapterView.OnItemClickListener {
        ...
        myList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if ("[]".equals(s)){
                    ...
                    Intent intent = new Intent(context, ServiceCenter3Activity.class);
