...
import cn.qimate.bike.adapter.MyInviterListAdapter;
...
import cn.qimate.bike.model.MyInviterListBean;
...
public class MyInviterListActivity extends SwipeBackActivity implements View.OnClickListener,SwipeRefreshLayout.OnRefreshListener,
    ...
    private MyInviterListAdapter myAdapter;
    private List<MyInviterListBean>data;
    ...
    private void initView(){
        ...
        myAdapter = new MyInviterListAdapter(context);
    ...
    public void onClick(View v) {
        ...
        HttpHelper.get(context, Urls.myMsg, params, new TextHttpResponseHandler() {
            @Override
            public void onStart() {
                setFooterType(1);
            }
                ...
                try {
                    ...
                    if ("Success".equals(result.getFlag())) {
                        ...
                        for (int i = 0; i < array.length(); i++) {
                            MyInviterListBean bean = JSON.parseObject(array.getJSONObject(i).toString(), MyInviterListBean.class);
                            data.add(bean);
                        }
