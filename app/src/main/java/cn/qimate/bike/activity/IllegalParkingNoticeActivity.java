...
/**
 * 违停通知
 * Created by yuanyi on 2019/4/4.
 */
@SuppressLint("NewApi")
public class IllegalParkingNoticeActivity extends SwipeBackActivity implements View.OnClickListener,
...
//    public static boolean screen = true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_illegal_parking_notice);
        context = this;
//        instance = this;
        BikeFragment.tz = 0;
            ...
            if (checkPermission != PackageManager.PERMISSION_GRANTED) {
                if (shouldShowRequestPermissionRationale(Manifest.permission.ACCESS_FINE_LOCATION)) {
                    ...
                    customBuilder.setTitle("温馨提示").setMessage("您需要在设置里打开位置权限！")
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            dialog.cancel();
                            IllegalParkingNoticeActivity.this.requestPermissions(
                ...
                if ("查看密码".equals(tv_lookPsdBtn.getText().toString().trim())){
                    ...
                    if("3".equals(type)){
                        ...
                        if (!getPackageManager().hasSystemFeature(PackageManager.FEATURE_BLUETOOTH_LE)) {
                            ToastUtil.showMessageApp(IllegalParkingNoticeActivity.this, "您的设备不支持蓝牙4.0");
                            scrollToFinishActivity();
                        }
                        //蓝牙锁
...
//                    lockLoading = null;
                ...
                ToastUtil.showMessageApp(IllegalParkingNoticeActivity.this,"设备连接成功");
                switch (flag){
                    case 0:
                        break;
                    case 1:
            ...
            case Config.LOCK_STATUS_ACTION:
                ...
                if (TextUtils.isEmpty(data)) {
                    ...
                    if (mBluetoothAdapter == null) {
                        ToastUtil.showMessageApp(IllegalParkingNoticeActivity.this, "获取蓝牙失败");
                        scrollToFinishActivity();
                        return;
                    }
    ...
    public boolean handleMessage(Message mes) {
        switch (mes.what) {
            case 0:
                ...
                BaseApplication.getInstance().getIBLE().connect(m_nowMac, IllegalParkingNoticeActivity.this);
                break;
            case 1:
                break;
            case 2:
            ...
            public void onClick(View v) {
                switch (v.getId()){
                    ...
                    case R.id.pop_menu_callLayout:
                        if (Build.VERSION.SDK_INT >= 23) {
                            int checkPermission = IllegalParkingNoticeActivity.this.checkSelfPermission(Manifest.permission.CALL_PHONE);
                            if (checkPermission != PackageManager.PERMISSION_GRANTED) {
                                if (shouldShowRequestPermissionRationale(Manifest.permission.CALL_PHONE)) {
                                    requestPermissions(new String[] { Manifest.permission.CALL_PHONE }, 0);
                                } else {
                                    CustomDialog.Builder customBuilder = new CustomDialog.Builder(IllegalParkingNoticeActivity.this);
                                    customBuilder.setTitle("温馨提示").setMessage("您需要在设置里打开拨打电话权限！")
                                            .setNegativeButton("取消", new DialogInterface.OnClickListener() {
                                                public void onClick(DialogInterface dialog, int which) {
                                                    dialog.cancel();
