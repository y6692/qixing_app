...
import cn.qimate.bike.adapter.RechargeRecordAdapter;
...
public class RechargeRecordActivity extends SwipeBackActivity implements View.OnClickListener,SwipeRefreshLayout.OnRefreshListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ui_recharge_record);
        datas = new ArrayList<>();
        initView();
    }
    ...
    private void initView(){
        ...
        myAdapter = new RechargeRecordAdapter(context);
    ...
    private void initHttp(){
        ...
        HttpHelper.get(context, Urls.rechargeLog, params, new TextHttpResponseHandler() {
            @Override
            public void onStart() {
                setFooterType(1);
            }
                ...
                try {
                    ...
                    if ("Success".equals(result.getFlag())) {
                        ...
                        for (int i = 0; i < array.length(); i++) {
                            RechargeRecordBean bean = JSON.parseObject(array.getJSONObject(i).toString(), RechargeRecordBean.class);
                            datas.add(bean);
                        }
