...
//                                            if ("2".equals(type) || "3".equals(type)){
//
//                                                Log.e("mf===cycling_5", loadingDialog.isShowing()+"===");
//
//                                                if (loadingDialog2 != null && !loadingDialog2.isShowing()){
//                                                    loadingDialog2.setTitle("正在唤醒车锁");
//                                                    loadingDialog2.show();
//                                                }
//
//                                                isOpenLock = false;
...
//                            iv_help.setVisibility(View.GONE);
    ...
    private void car_notification(final int action_type, final int lock_status, int back_type) {
...
//                                getLockStatus();
                                ...
                                Toast.makeText(context,"蓝牙连接失败，请靠近车锁，重启手机试试吧！",Toast.LENGTH_LONG).show();
                            }else{
                                unlock();
                            }
                        }
...
//        loadingDialog.show();
        ...
        Log.e("connect===", carmodel_id+"==="+type+"==="+isLookPsdBtn+"==="+isOpenLock);
...
//                    closeLoadingDialog();
                ...
                case 0x98://搜索超时
                    ...
                    Log.e("0x98===", isLookPsdBtn+"==="+isStop);
...
//                            closeLoadingDialog();
                            ...
                            Log.e("188===", unauthorized_code+"==="+isConnect+"==="+isLookPsdBtn+"==="+oid+"==="+m_nowMac+"==="+type+">>>"+isOpenLock+"==="+isEndBtn);
